    ...
    <>
      <Card sx={{ m: 0 }}>
        <CardContent>
          ...
          Telephonic Registered Patients View
          </Typography>
          <Grid
            container
            direction="row"
                    ...
                    return (
                      ...
                      >
                        {columns.map((column) => {
                          ...
                          return (
                            <>
                            {column.id=='TelephonicID' ? 
                              <TableCell key={column.id} align={column.align}>
                              <Link underline="hover" color="inherit" href="/telephonicRegistration">
                                {row.TelephonicID}
                              </Link>
                             </TableCell>
                              :
...
export default TelephonicRegEdit;
