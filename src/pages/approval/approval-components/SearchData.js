...
const SearchData = () => {
  ...
  return (
    <>
        <Typography mb={2} variant='body1' component='h1' sx={{textAlign:'center', justifyContent:'center', textDecoration:'underline', color:'primary.main', fontWeight:'bold'}} mt={2}>Click here to export all required data</Typography> 
