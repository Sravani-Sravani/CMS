  ...
  return (
    <>
      <Box display='flex' justifyContent='space-between' alignItems='center'>
        <Typography variant='body1' color='text.secondary'>CMS DashBoard</Typography>
              ...
              <Grid xs={12} sm={4} item>
                <Card sx={{boxShadow:3, display:'block', width:'auto', height:'auto', borderRadius:'5px'}} >
                  <CardContent>
                    ...
                    <Typography sx={{ fontSize: 10, fontFamily:'Lato, sans-serif' }} color="text.secondary" gutterBottom>
                        Total No. of CRs
                      </Typography>
